...
data_file = 'transmission_spectrum_vfinal_bin0.5_utc20230606_123544.nc'
hst_file = 'W17_transmission_spectrum.txt'
data_dict = get_data(data_file, hst_file, add_hst=True)

#2) specify tag name to help you keep track of the run 
tag = 'ExoTIC-MIRI+HST+virga'

#3) where do you want to save your results 
out_dir = 'gridtrieval_files/emission_clouds/'

#4) Specify models to test
model_type = 'cld_free_virga' 
...
def loglike(cube):#, ndim, nparams):
    ...
    #print(len(y_data_all), len(y_model_all))
