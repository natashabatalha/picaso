...
def loglike(cube):#, ndim, nparams):
    ...
    #print(data_dict['Eureka!'][0])
    #go through data and regird ( i don't think i need to do this)
    x_chunk, y_chunk=jdi.mean_regrid(resultx, resulty, newx=data_dict['Eureka!'][0])
    y_model_all += [y_chunk]
    x_data_all += [x_chunk]
    y_data_all += [data_dict['Eureka!'][1]]
    e_data_all += [data_dict['Eureka!'][2]]
