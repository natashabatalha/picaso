...
#
# In this tutorial you will learn how to run 1-D climate models for brown dwarfs with Virga clouds included self-consistently! For a more in depth look at the climate-cloud code check out [Mang et al. 2026](https://ui.adsabs.harvard.edu/abs/2026ApJ..1000...98M/abstract) (note this should also be cited if using this code/tutorial).
#
...
tint = 200 # Intrinsic Temperature of your Brown Dwarf in K
