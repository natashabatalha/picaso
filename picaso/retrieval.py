...
def atlev_deprecate(l0,pressure_layer):
...
def picaso_format_deprecate(opd, w0, g0, wavenumber_grid, pressure_grid ,
...
def create_template_deprecate(rtype, script_filename, sampler_output_path, 
    grid_kwargs={}):
    """
...
def remove_lines_with_markers_deprecate(text):
...
def remove_code_blocks_deprecate(text, tag):
    """
