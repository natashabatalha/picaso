...
__global__ void fill_flux_plus_minus(double *all_b_dev, double *b1_dev, double *tau_top_dev, double ubar1,double *flux_plus_dev, double *flux_minus_dev, double hard_surface,
                                    int nlevel, int nwno){
