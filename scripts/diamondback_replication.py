...
for fsed in [1, 2, 3, 4]:
    ...
    nstr_upper = 66 # top most level of guessed convective zone
    ...
    with h5py.File(f"../data/convh5/convergence_fsed{fsed}_teff{teff}_dt{datetime.now().isoformat().replace(":", ".")}.h5", "w") as f:
